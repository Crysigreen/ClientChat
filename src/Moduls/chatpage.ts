  ...
  template: `
    <div class="bg-gray-100 flex flex-col h-full">
      ...
      <div class="flex-1 overflow-y-auto px-4 py-2">
        <div *ngFor="let message of messages" class="flex justify-end">
          <div [ngClass]="{'ml-auto': message.from === 'me'}" class="bg-white rounded-lg p-2 mb-2 inline-block max-w-xs whitespace-normal break-words">
